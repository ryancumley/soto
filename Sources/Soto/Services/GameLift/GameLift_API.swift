...
public struct GameLift: AWSService {
    ...
    public func createFleetLocations(_ input: CreateFleetLocationsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateFleetLocationsOutput> {
        return self.client.execute(operation: "CreateFleetLocations", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    #if compiler(>=5.4) && $AsyncAwait
    public func createFleetLocations(_ input: CreateFleetLocationsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateFleetLocationsOutput {
        return try await self.client.execute(operation: "CreateFleetLocations", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    public func deleteFleetLocations(_ input: DeleteFleetLocationsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteFleetLocationsOutput> {
        return self.client.execute(operation: "DeleteFleetLocations", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    #if compiler(>=5.4) && $AsyncAwait
    public func deleteFleetLocations(_ input: DeleteFleetLocationsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteFleetLocationsOutput {
        return try await self.client.execute(operation: "DeleteFleetLocations", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    public func describeFleetLocationAttributes(_ input: DescribeFleetLocationAttributesInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeFleetLocationAttributesOutput> {
        return self.client.execute(operation: "DescribeFleetLocationAttributes", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    #if compiler(>=5.4) && $AsyncAwait
    public func describeFleetLocationAttributes(_ input: DescribeFleetLocationAttributesInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeFleetLocationAttributesOutput {
        return try await self.client.execute(operation: "DescribeFleetLocationAttributes", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    public func describeFleetLocationCapacity(_ input: DescribeFleetLocationCapacityInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeFleetLocationCapacityOutput> {
        return self.client.execute(operation: "DescribeFleetLocationCapacity", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    #if compiler(>=5.4) && $AsyncAwait
    public func describeFleetLocationCapacity(_ input: DescribeFleetLocationCapacityInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeFleetLocationCapacityOutput {
        return try await self.client.execute(operation: "DescribeFleetLocationCapacity", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    public func describeFleetLocationUtilization(_ input: DescribeFleetLocationUtilizationInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeFleetLocationUtilizationOutput> {
        return self.client.execute(operation: "DescribeFleetLocationUtilization", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    #if compiler(>=5.4) && $AsyncAwait
    public func describeFleetLocationUtilization(_ input: DescribeFleetLocationUtilizationInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeFleetLocationUtilizationOutput {
        return try await self.client.execute(operation: "DescribeFleetLocationUtilization", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
