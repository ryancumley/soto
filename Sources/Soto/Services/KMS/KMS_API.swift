...
public struct KMS: AWSService {
    ...
    public func cancelKeyDeletion(_ input: CancelKeyDeletionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CancelKeyDeletionResponse {
        return try await self.client.execute(operation: "CancelKeyDeletion", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func connectCustomKeyStore(_ input: ConnectCustomKeyStoreRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ConnectCustomKeyStoreResponse {
        return try await self.client.execute(operation: "ConnectCustomKeyStore", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func createAlias(_ input: CreateAliasRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws {
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func createCustomKeyStore(_ input: CreateCustomKeyStoreRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateCustomKeyStoreResponse {
        return try await self.client.execute(operation: "CreateCustomKeyStore", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    public func createKey(_ input: CreateKeyRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateKeyResponse {
        return try await self.client.execute(operation: "CreateKey", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func decrypt(_ input: DecryptRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DecryptResponse {
        return try await self.client.execute(operation: "Decrypt", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func deleteCustomKeyStore(_ input: DeleteCustomKeyStoreRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteCustomKeyStoreResponse {
        return try await self.client.execute(operation: "DeleteCustomKeyStore", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func deleteImportedKeyMaterial(_ input: DeleteImportedKeyMaterialRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws {
        return try await self.client.execute(operation: "DeleteImportedKeyMaterial", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func describeCustomKeyStores(_ input: DescribeCustomKeyStoresRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeCustomKeyStoresResponse {
        return try await self.client.execute(operation: "DescribeCustomKeyStores", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    public func describeKey(_ input: DescribeKeyRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeKeyResponse {
        return try await self.client.execute(operation: "DescribeKey", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func disableKey(_ input: DisableKeyRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws {
        return try await self.client.execute(operation: "DisableKey", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func disableKeyRotation(_ input: DisableKeyRotationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws {
        return try await self.client.execute(operation: "DisableKeyRotation", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func disconnectCustomKeyStore(_ input: DisconnectCustomKeyStoreRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DisconnectCustomKeyStoreResponse {
        return try await self.client.execute(operation: "DisconnectCustomKeyStore", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func enableKey(_ input: EnableKeyRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws {
        return try await self.client.execute(operation: "EnableKey", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func enableKeyRotation(_ input: EnableKeyRotationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws {
        return try await self.client.execute(operation: "EnableKeyRotation", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func encrypt(_ input: EncryptRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> EncryptResponse {
        return try await self.client.execute(operation: "Encrypt", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func generateDataKey(_ input: GenerateDataKeyRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GenerateDataKeyResponse {
        return try await self.client.execute(operation: "GenerateDataKey", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func generateDataKeyPair(_ input: GenerateDataKeyPairRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GenerateDataKeyPairResponse {
        return try await self.client.execute(operation: "GenerateDataKeyPair", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func generateDataKeyPairWithoutPlaintext(_ input: GenerateDataKeyPairWithoutPlaintextRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GenerateDataKeyPairWithoutPlaintextResponse {
        return try await self.client.execute(operation: "GenerateDataKeyPairWithoutPlaintext", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func generateDataKeyWithoutPlaintext(_ input: GenerateDataKeyWithoutPlaintextRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GenerateDataKeyWithoutPlaintextResponse {
        return try await self.client.execute(operation: "GenerateDataKeyWithoutPlaintext", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func generateRandom(_ input: GenerateRandomRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GenerateRandomResponse {
        return try await self.client.execute(operation: "GenerateRandom", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func getKeyPolicy(_ input: GetKeyPolicyRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetKeyPolicyResponse {
        return try await self.client.execute(operation: "GetKeyPolicy", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func getKeyRotationStatus(_ input: GetKeyRotationStatusRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetKeyRotationStatusResponse {
        return try await self.client.execute(operation: "GetKeyRotationStatus", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func getParametersForImport(_ input: GetParametersForImportRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetParametersForImportResponse {
        return try await self.client.execute(operation: "GetParametersForImport", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func getPublicKey(_ input: GetPublicKeyRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetPublicKeyResponse {
        return try await self.client.execute(operation: "GetPublicKey", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func importKeyMaterial(_ input: ImportKeyMaterialRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ImportKeyMaterialResponse {
        return try await self.client.execute(operation: "ImportKeyMaterial", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func listGrants(_ input: ListGrantsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListGrantsResponse {
        return try await self.client.execute(operation: "ListGrants", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func listKeyPolicies(_ input: ListKeyPoliciesRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListKeyPoliciesResponse {
        return try await self.client.execute(operation: "ListKeyPolicies", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    public func listKeys(_ input: ListKeysRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListKeysResponse {
        return try await self.client.execute(operation: "ListKeys", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func listResourceTags(_ input: ListResourceTagsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListResourceTagsResponse {
        return try await self.client.execute(operation: "ListResourceTags", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func listRetirableGrants(_ input: ListRetirableGrantsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListGrantsResponse {
        return try await self.client.execute(operation: "ListRetirableGrants", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func putKeyPolicy(_ input: PutKeyPolicyRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws {
        return try await self.client.execute(operation: "PutKeyPolicy", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func reEncrypt(_ input: ReEncryptRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ReEncryptResponse {
        return try await self.client.execute(operation: "ReEncrypt", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func retireGrant(_ input: RetireGrantRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws {
        return try await self.client.execute(operation: "RetireGrant", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func revokeGrant(_ input: RevokeGrantRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws {
        return try await self.client.execute(operation: "RevokeGrant", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func scheduleKeyDeletion(_ input: ScheduleKeyDeletionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ScheduleKeyDeletionResponse {
        return try await self.client.execute(operation: "ScheduleKeyDeletion", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func sign(_ input: SignRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> SignResponse {
        return try await self.client.execute(operation: "Sign", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func updateAlias(_ input: UpdateAliasRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws {
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func updateCustomKeyStore(_ input: UpdateCustomKeyStoreRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateCustomKeyStoreResponse {
        return try await self.client.execute(operation: "UpdateCustomKeyStore", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func updateKeyDescription(_ input: UpdateKeyDescriptionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws {
        return try await self.client.execute(operation: "UpdateKeyDescription", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    #if compiler(>=5.4) && $AsyncAwait
    public func verify(_ input: VerifyRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> VerifyResponse {
        return try await self.client.execute(operation: "Verify", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
}
