...
public struct EKS: AWSService {
    ...
    public func associateEncryptionConfig(_ input: AssociateEncryptionConfigRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> AssociateEncryptionConfigResponse {
        return try await self.client.execute(operation: "AssociateEncryptionConfig", path: "/clusters/{name}/encryption-config/associate", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    public func associateIdentityProviderConfig(_ input: AssociateIdentityProviderConfigRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> AssociateIdentityProviderConfigResponse {
        return try await self.client.execute(operation: "AssociateIdentityProviderConfig", path: "/clusters/{name}/identity-provider-configs/associate", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    public func describeIdentityProviderConfig(_ input: DescribeIdentityProviderConfigRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeIdentityProviderConfigResponse {
        return try await self.client.execute(operation: "DescribeIdentityProviderConfig", path: "/clusters/{name}/identity-provider-configs/describe", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    public func disassociateIdentityProviderConfig(_ input: DisassociateIdentityProviderConfigRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DisassociateIdentityProviderConfigResponse {
        return try await self.client.execute(operation: "DisassociateIdentityProviderConfig", path: "/clusters/{name}/identity-provider-configs/disassociate", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
    ...
    public func listIdentityProviderConfigs(_ input: ListIdentityProviderConfigsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListIdentityProviderConfigsResponse {
        return try await self.client.execute(operation: "ListIdentityProviderConfigs", path: "/clusters/{name}/identity-provider-configs", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    #endif
